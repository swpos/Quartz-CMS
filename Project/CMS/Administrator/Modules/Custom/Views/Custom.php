<?php echo $top_menu; ?>
<h1><?php echo EDIT_CUSTOM_MODULE ?></h1>
<?php echo $error; ?>
<form action="index.php?page=Custom&action=_edit_module_update&id=<?php echo $id; ?>" method="post" id="validator" role="form">
    <div class="row">
 	   <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <table class="table-info table-striped">
                <tr>
                    <td><?php echo $form['modules']['content']['control']; ?></td>
                </tr>
            </table>
        </div>
    </div>
