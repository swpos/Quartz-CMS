...
<?php } else { ?>
    <form name='form1' id='connexion' method='post' action='index.php?page=Login&action=login_connexion_update'>
        ...
        <p><?php echo LOGIN_USERNAME ?> : <input type='text' value='admin' name='username' size='15'/></p> 
        <p><?php echo LOGIN_PASSWORD ?> : <input type='password' value='123456' name='password' size='15'/></p> 
