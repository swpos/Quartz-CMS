...
<form action="index.php" method="post" id="validator" role="form">
	...
	<input type="submit" class="btn btn-default" size="20" value="Search" name="post_order_module" />
</form>
...
?>
		<tr>
            ...
            <td><input type="text" class="form-control" value="<?php echo $al_order1 ?>" name="order[<?php echo $al_id ?>]" /></td>
