            ...
            <td>
            	<ul>
				   <?php 
                    ...
                    ?>
                 				<li><input type="checkbox" name="shortcut[]" value="<?php echo $al_shortcut_unique ?>" checked="checked" /> Alias : <?php echo $al_shortcut_unique ?></li>
                    <?php
					        } else {
					?>
                                <li><input type="checkbox" name="shortcut[]" value="<?php echo $al_shortcut_unique ?>" /> Alias : <?php echo $al_shortcut_unique ?></li>
                    <?php
                            }
                        }
					?>
