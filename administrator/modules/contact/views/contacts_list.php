...
<form action="index.php?page=list_contact&action=post_admin" method="post" id="validator" role="form">
    <table class="table-striped list">
		...
		<tr>
			<td><input type="submit" class="btn btn-primary" size="20" value="Update" /></td>
		</tr>
	</table>
</form>
<div class="row">
    <div class="col-md-2">
        <form action="index.php?page=list_contact" method="post" id="validator" role="form">
            <div class="well">
                ...
                <p><input type="submit" class="btn btn-primary" size="20" value="Search" name="post_order_contact" /></p>
            </div>
        </form>
    </div>
    <div class="col-md-10">
